...
exports.uploadFile = async (req, res) => {
  ...
  if (req.file) {
    ...
    try {
      let sql = `INSERT INTO plateinfo(raw_data_name,raw_data_path) VALUES ('${req.file.filename}', '${escapedPath}')`;
...
exports.exceluploadFile = (req, res) => {
  ...
  console.log("hey i am excel file", req.file);
  console.log("hey i am excel file", req.body.text);
  let fileData = {};
...
// Again above:-
exports.sendimgtext = async (req, res) => {
  // Handle Image Upload
